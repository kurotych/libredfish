// Read-only: runs Redfish::lockdown_status against a real BMC and prints
// the message and status. Reads BMC, USER, PASS from env.
//
// Run with:
//   RUST_LOG=debug BMC=https://10.213.2.184 USER=admin PASS=... \
//       cargo run --example lockdown_status
